...
function Encryption() {
    ...
    const [encrptedText, setEncryptedText] = useState();
    ...
    return <>
        ...
        <TextField label="Text to be decrypted" variant="standard" color="warning" style={{ width: 350, marginTop: 30 }} value={plainText} onChange={e => setPlainText(e.target.value)} />
        ...
        <br />
        {encrptedText && <p>Encrypted Text: {encrptedText}</p>}
